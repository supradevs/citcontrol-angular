...
export class PlannerCalendarComponent {
  ...
  mod(){
    ...
    this.events[this.test.index].start = new Date(this.test.inicio)
    this.events[this.test.index].end = new Date(this.test.fin)
    console.log(this.events[this.test.index],new Date(this.test.inicio),new Date(this.test.fin))
  }
